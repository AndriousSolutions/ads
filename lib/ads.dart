...
class Ads {
  ...
  static Future<bool> setVideoAd({
    ...
    bool loaded = await _rewardedVideoAd.load(adUnitId: adModId, targetingInfo: info);

    _videoAd = _VideoAd(adUnitId: adModId, targetingInfo: info, ad: _rewardedVideoAd);
    return loaded;
  }
  ...
  static MobileAdTargetingInfo _targetInfo({
      ...
      bool init = keywords == null && contentUrl == null && childDirected == null && testDevices == null;
